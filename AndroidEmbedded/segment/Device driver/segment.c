...
ssize_t segment_write(struct file *inode, const char *gdata, size_t length, loff_t *off_what)
{
	...
	unsigned char waiting[6]={0xf0,0x90,0x90,0x90,0x90,0x9c};// 답 출력 전 상태 일때
	unsigned char waiting2[6]={0,0,0,0,0,0};// 전원 소등
	// 아무것도 안하고 대기 상태일때
	...
	// num이 0 일 수도 있음.... 0 일때 data[0] 에다가만 0xfc
